...
model = "gpt-5"     # or "claude-3-5-sonnet-latest"
```
...
| ↑/↓          | Navigate query list (when sidebar focused) |
...
│ 2  │ bob@test.com   │ Bob        │ 2024-01-16 14:22:00 │
│ 3  │ carol@test.com │ NULL       │ 2024-01-17 09:15:00 │
└────┴────────────────┴────────────┴─────────────────────┘
